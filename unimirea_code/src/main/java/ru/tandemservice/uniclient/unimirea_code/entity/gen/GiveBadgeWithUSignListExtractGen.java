...
public abstract class GiveBadgeWithUSignListExtractGen extends ListStudentExtract
{
    ...
    public static final int VERSION_HASH = -1186519760;
    ...
    public void update(IEntity another, boolean withNaturalIdProperties)
    {
        ...
        {
            setCourse(((GiveBadgeWithUSignListExtract)another).getCourse());
            setGroup(((GiveBadgeWithUSignListExtract)another).getGroup());
        }
    }
    ...
    /**
     * @return Курс. Свойство не может быть null.
     * @see ru.tandemservice.uniclient.unimirea_code.entity.GiveBadgeWithUSignListExtract#getCourse()
     */
    ...
    /**
     * @return Группа. Свойство не может быть null.
     * @see ru.tandemservice.uniclient.unimirea_code.entity.GiveBadgeWithUSignListExtract#getGroup()
     */
